...
export class TodoService {
  ...
  getListsByUser(): Observable<IList[]>{
    ...
    // We'll just return the result of a get request
      ...
      // Send the request 
      return this.http.get<IList[]>(`http://localhost:8080/lists`, headers)
  ...
  getListById(listId: number): Observable<IList>{
    ...
    // We'll just return the result of a get request
      ...
      // Send the request 
      return this.http.get<IList>(`http://localhost:8080/lists/${listId}`, headers)
  ...
  createNewTodo(todo: ITodo, listId: number): Observable<ITodo>{
    ...
    return this.http.post<ITodo>(`http://localhost:8080/todos`, JSON.stringify(todo), headers)
  ...
  updateTodo(todo: ITodo) : Observable<ITodo>{
    ...
    return this.http.put<ITodo>(`http://localhost:8080/todos`, JSON.stringify(todo), headers)
  }
  ...
  deleteTodoById(todoId: number): Observable<boolean>{
    ...
    return this.http.delete<boolean>(`http://localhost:8080/todos/${todoId}`)
  }
