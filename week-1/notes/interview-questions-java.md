...
* Explain the concept of Brute Force/Linear Search?
    - Systematically checking for all possible solutions through an exhaustive search 
* What are some benefits to Brute Force/Linear Search?
...
* What are some downsides to Brute Force/Linear Search?
...
* What is the time complexity of Merge Sort?
    - Runtime is O(n log n) which is much faster and requires less operations than Bubble Sort O(n<sup>2</sup>)
* What is a map?
